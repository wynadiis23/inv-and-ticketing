...
<div class="card">
    <div class="card-header">
        Detail Data Peminjaman {{$peminjaman->email}}
    </div>
    ...
    <div class="card-body">
        <form action="">
            ...
            <div class="form-group {{ $errors->has('tanggal_kembali') ? 'has-error' : '' }}">
                ...
                <input type="date" id="tanggal_kembali" name="tanggal_kembali" class="form-control" value="{{ old('tanggal_kembali', isset($peminjaman) ? $peminjaman->tanggal_kembali : '') }}" disabled>
                <input type="date" id="tanggal_kembali" name="tanggal_kembali" class="form-control" value="{{ old('tanggal_kembali', isset($peminjaman) ? $peminjaman->tanggal_kembali : '') }}" hidden>
            ...
            <img src="{{ asset('storage/'. $peminjaman->photo_path) }}" class="img-fluid" alt="...">
            <br>
            <br>
            <div>
